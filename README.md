...
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|----------|
| Shrink Factor (float)             | Enter a shrink factor to determine how much each iteration of the image is reduced in size.         | `--shrink_factor 0.99`                                           | Yes      |
...
| Rotation Angle (float)            | Enter the rotation angle per iteration to apply a cumulative rotation effect to each image iteration. Use a negative number to rotate the image clockwise. | `--rotation_angle 60`                                           | Yes      |
