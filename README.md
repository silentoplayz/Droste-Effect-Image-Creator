...
| Output Format (string)            | Choose the format for saving the final output image (e.g., `png`, `jpg`, `jpeg`, `bmp`, `webp`).                      | `--output_format jpg`                                           | No       | bmp                      |
| Output Path (string)              | Path for the output image.                                                                                      | `--output_path path/to/save/output.jpg`                          | No       | output_image.bmp         |
