...
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|------------------------------------|-------------------------------------|
| Arguments Help (argument)                   | Display help information about the command-line arguments and their usage.                                        | `-h` or `--help`                                                 | No                                 | **N/A**                             |
...
| Include Reverse (boolean)         | Decide whether to include concatenate the reversed clip at the end of the timelapse video.                   | `--include_reverse no`                                           | No                                 | `False`                             |
| Save Reversed Clip (boolean)      | Choose whether to save the reversed timelapse video separately. | `--save_reversed yes`                                            | No                                 | `True`                              |
...
| Rotation Angle (float)            | Enter the rotation angle per iteration to apply a cumulative rotation effect to each image iteration. Use a negative number to rotate the image clockwise. | `--rotation_angle 60`                                            | No                                 | `0`                                 |
...
| Output Path (string)              | Directory path for script's media output.                                                                                     | `--output_path path/to/save/output.bmp`                           | **No!**                            | **Script directory path**           |
